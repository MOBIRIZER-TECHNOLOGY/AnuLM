...
REM http://127.0.0.1:8000. Registered as the scheduled task nanosarvam_serve,
...
REM   schtasks /change /tn nanosarvam_serve /disable
...
start "nanosarvam-serve" /min "%~dp0_serve_run.cmd"
exit /b 0
